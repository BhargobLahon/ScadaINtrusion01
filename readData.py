...
def readTrainSamplesNetworkData(commandFile,responseFile,startLine=1,samplingPeriod=1000,nSamples=-1) :
	...
	print(f"nSamples = {nSamplePoints}")
...
if __name__ == "__main__":
    # Use raw strings (r prefix) for Windows paths
    commandFile = r'C:\Users\lahon\OneDrive\Desktop\New folder (2)\VPP\ScadaIntrusion\ScadaIntrusion\scada-intrusion-detection\DataSets\Command_Injection\AddressScanScrubbedV2.csv'
    responseFile = r'C:\Users\lahon\OneDrive\Desktop\New folder (2)\VPP\ScadaIntrusion\ScadaIntrusion\scada-intrusion-detection\DataSets\Response_Injection\ScrubbedBurstV2\scrubbedBurstV2.csv'
